...
//When one is dlicked, show pickers in parent to allow user to edit them
var PressableExerciseParameters = React.createClass({
  render: function(){
...
module.exports = PressableExerciseParameters;
